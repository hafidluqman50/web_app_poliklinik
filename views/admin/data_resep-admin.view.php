	...
	<section class="content">
		...
		<div class="data-table">
			<div class="data-table-header">
				<a href="?c=admin&m=tambah_data_resep">
					...
					<tbody>
						<?php if ($cek != 0): ?>
							...
							<tr>
								...
								<td>
									<a href="?c=admin&m=detail_data_resep&id=<?= $resep['id_resep'] ?>">
										<button class="btn btn-primary-outline btn-action">
											Detail
										</button>
									</a>
									<a href="?c=admin&m=delete_data_resep&id=<?= $resep['id_resep'] ?>" onclick="return confirm('Yakin Hapus Data?');">
