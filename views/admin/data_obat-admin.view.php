	...
	<section class="content">
		...
		<div class="data-table">
			<div class="data-table-header">
				<a href="?c=admin&m=tambah_data_obat">
					...
					<tbody>
						<?php if ($cek != 0): ?>
							...
							<tr>
								...
								<td><a href="?c=admin&m=edit_data_obat&id=<?= $obat['id_obat'] ?>">
										<button class="btn btn-warning-outline btn-action">
											Edit
										</button>
									</a>
									<a href="?c=admin&m=delete_data_obat&id=<?= $obat['id_obat'] ?>" onclick="return confirm('Yakin Hapus?');">
