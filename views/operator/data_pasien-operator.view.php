...
<section class="content">
		...
		<div class="data-table">
			<div class="data-table-header">
				<a href="?c=operator&m=tambah_data_pasien">
					...
					<tbody>
						<?php if ($cek != 0): ?>
							...
							<tr>
								...
								<td>
									<a href="?c=operator&m=edit_data_pasien&id=<?= $pasien['id_pasien'] ?>">
										<button class="btn btn-warning-outline btn-action">
											Edit
										</button>
									</a>
									<a href="?c=operator&m=delete_data_pasien&id=<?= $pasien['id_pasien'] ?>" onclick="return confirm('Yakin Hapus');">
