...
<?php $this->load('operator\navbar-operator') ?>
	<section class="content">
		...
		<form action="?c=operator&m=bayar&id=<?= $data->id_pendaftaran ?>" method="POST">
			<div class="bayar-body">
				...
				<div class="info-bayar">
					...
					<div class="info-group">
						...
						<div class="form-info">
							<input type="text" id="bayar" name="bayar" class="form-input">
						</div>
					</div>
					<div class="info-group">
						<label for="">Kembali</label>
						<div class="form-info">
							<input type="text" id="kembali" name="kembali" class="form-input">
						</div>
					</div>
				</div>
			</div>
			<div class="bayar-footer">
				<button class="btn btn-primary-outline btn-bayar" name="simpan">
					Bayar
				</button>
			</div>
		</form>
