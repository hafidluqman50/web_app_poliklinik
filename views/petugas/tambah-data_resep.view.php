...
<section class="content">
	<div class="resep">
		...
		<form action="?c=petugas&m=insert_data_resep" method="POST">
			<div class="body-resep">
				<div class="info-resep1">
					...
					<div class="form-resep">
						...
						<select name="poli" id="jagaw" class="form-input">
					...
					<div class="form-resep">
						...
						<input type="text" name="total_harga" class="form-input total-petugas" readonly>
					</div>
					<div class="form-resep">
						<label for="" class="label">Bayar</label>
						<input type="text" name="bayar" class="form-input bayar-petugas">
					</div>
					<div class="form-resep">
						<label for="" class="label">Kembali</label>
						<input type="text" name="kembali" class="form-input kembali-petugas">
					</div>
				...
				<div class="resep-dokter">
					<div class="form-resep" id="nm_obt">
						...
						<select name="obat[]" class="form-input obat-petugas">
					...
					<div class="form-resep" id="jml_obt">
						...
						<input type="text" name="bnyk_obt[]" class="form-input bnyk-petugas" placeholder="Jumlah Obat">
					</div>
